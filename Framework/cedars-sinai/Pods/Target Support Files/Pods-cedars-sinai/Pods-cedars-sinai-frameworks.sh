...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/PWCoreNoAds/Framework/PWCore.framework"
  install_framework "${PODS_ROOT}/PWEngagement/Framework/PWEngagement.framework"
  install_framework "${PODS_ROOT}/PWLocation/Framework/PWLocation.framework"
  install_framework "${PODS_ROOT}/PWMapKit/Framework/PWMapKit.framework"
